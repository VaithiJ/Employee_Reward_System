        ...
        >
          ...
          <div style={{ display: "flex", flexDirection: "row" }}>
            <img
              className="cmplg"
              src={companyImage}
              style={{ width: "450px", height: "500px",marginTop:"-10px", marginLeft: "100px" }}
            />
            <p
            style={{
              fontSize: "18px",
          ...
          >
            <b style={{ fontFamily: "Secular One" }}>
              Revolutionize Your Business with Blockchain <br/><b style={{color:"red", fontFamily:"Secular One"}}>Register</b> Now and
