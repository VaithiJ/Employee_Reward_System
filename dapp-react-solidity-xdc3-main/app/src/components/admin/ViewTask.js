...
<div className="modal-container" style={{ display: "flex", flexDirection: "column", alignItems: "center" }}>
     <header style={{ backgroundColor: "#69C5FA", padding: "1.5rem 0", height: "100px", color: "#F2F2F2", width: "100%" }}>
      ...
      <div
        className="mer5"
        style={{backgroundImage: `url(${bg})`, height:"900px",boxShadow: "-3px 5px 28px 1px rgba(0,0,0,0.74) inset",backgroundColor:"#BFF1EE",   display: "flex", flexDirection: "column", marginTop:"60px", height:"500px", width:"1000px" }}
      >
        <br />
